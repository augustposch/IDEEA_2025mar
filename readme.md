...
The current version uses temperature, relative humidity, zonal wind, and meridional wind, each at 925 hPa, 700 hPa, and 500 hPa, over Boston, to predict daily precipitation in the watersheds encompassing Boston's urban rail system. The current version is trained on 1975-1994 and validated on 1995-2014 using ERA5 reanalysis as predictors, which represents historical weather conditions. Then, climate-level validation is performed on 1995-2014 and future predictions are obtained for 2031-2050 and 2041-2060 with multiple initial conditions, using the CESM2 climate model outputs which represent simulated weather. Information about hyperparameters, metrics, trained model files, and visuals is provided within the notebook machine_learning.ipynb.
